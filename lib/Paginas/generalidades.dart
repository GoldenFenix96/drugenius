...
class _MyAppState extends State<MyApp> {
  ...
  List<Widget> _paginas = [
    ...
    paginaCUADROSBASICOS()
      ...
      //_onItemTapped
  void _combiar(int index) {
    setState(() {
      //currentIndex
      _paginaActual = index; // Cambia el índice al tocar el ítem
    });
  }
  @override
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Generalidades'),
              ...
              //pages   currentIndex
        body: _paginas[_paginaActual], // Muestra la página actual según el índice
    
        bottomNavigationBar: BottomNavigationBar(
          
                items: [
                  BottomNavigationBarItem(icon: Icon(Icons.align_horizontal_left_sharp),label: 'Introduccion',backgroundColor: Color.fromARGB(255, 207, 187, 4)),
                  BottomNavigationBarItem(icon: Icon(Icons.align_horizontal_left_sharp),label: 'Farmacodinamia',),
                  BottomNavigationBarItem(icon: Icon(Icons.align_horizontal_left_sharp),label: 'Farmacocinética',),
                  BottomNavigationBarItem(icon: Icon(Icons.align_horizontal_left_sharp),label: 'Cuadros básicos ',),
  ...
  Widget build(BuildContext context) {
          ...
          children: [
            ...
            Container(
              child: Center(
                ...
                "La FDA (Food and Drug Administration) es la agencia reguladora responsable de proteger la salud pública, al garantiar la seguridad, eficacia y seguridad de los fármacos para uso en los humanos o para uso veterinario, productos biológicos, dispositivos médicos, alimentos, cosméticos y productos que emiten radiación. Por ende, el sacar un fármaco al mercado no es nada sencillo, ya que pasan por diversas pruebas, es decir, pueden competir desde 10,000 a 25,000 entidades químicas, pero solo 1 puedo lograr el registro de la patente.\n\n"+
                "Y, ya que el proceso de fármacos es largo, costoso y arriesgado, los fármacos deben tener un precio para recuperar todo el dinero invertido.\n\n"+
                "Los conceptos básicos para aprender dentro de este tema son\n\n"+
    ...
    Padding(
      ...
      child: Column(
        children: [
          Container(
            child: Text("Bibliografía consultada",
            style: TextStyle(
    ...
    Padding(
        ...
        child: Column(
          children: [
            ...
            Container(
              child: Center(
                child: Text("•	Ledón Pérez, L. E., & Hernández Pérez, A. (2013). Farmacología general.\n"+
      ...
      Padding(
        ...
        child: Column(
          children: [
            ...
            Container(
              child: Center(
                child: Text("La farmacodinamia es el estudio de los efectos bioquímicos, celulares y fisiológicos de los fármacos y sus mecanismos de acción. Los efectos de la mayoría de los fármacos son el resultado de su interacción con los componentes macromoleculares del organismo, como los receptores.  \n\n"+
                ...
                "Podemos clasificar a los fármacos dependiendo de su acción sobre los receptores:\n\n"
      ...
      Padding(
        ...
        child: Column(
          children: [
            ...
            Container(
              child: Center(
                child: Text("La farmacocinética se encarga de estudiar los procesos a los cuales es sometido un fármaco dentro del organismo, a través de todo su paso en el interior, y hasta el exterior de este, es decir, desde el momento en el que un fármaco es administrado hasta su total eliminación del organismo.\n\n"+
              ...
              children: [
                TableRow(
                  children: [
                    ...
                    TableCell(
                      child: Center(
                        child: Text("Cuadro básico\nde\nmedicamentos\ndel IMSS\n(México, 2018)",textAlign: TextAlign.center,),
                      ),
                    ),
                    
                    TableCell(
                      child: Center(
                        child: Text("Listas\nModelos de\nMedicamentos\nEsenciales\n(OMS, 2021)",textAlign: TextAlign.center,),
                      ),
                    ),
                    TableCell(
                      child: Center(
                        child: Text("Listado de\nMedicamentos\nEstratégicos\m(España, 2022)",textAlign: TextAlign.center,),
                      ),
                    ),
                    TableCell(
                      child: Center(
                        child: Text("Guía de\nmedicamentos\nde la FDA\n(Estados Unidos)",textAlign: TextAlign.center,),
                      ),
                    ),
                  ],
                ),
                TableRow(
                  children: [
                    TableCell(
                      child: Center(
                        child: Text("Ácido\nacetilsalicílico ",textAlign: TextAlign.center,),
                      ),
                    ),
                    TableCell(
                      child: Center(
                ...
                TableRow(
                  children: [
                    TableCell(
                      child: Center(
                        child: Text("Diclofenaco",textAlign: TextAlign.center,),
                      ),
                    ),
                    TableCell(
                      child: Center(
                ...
                TableRow(
                  children: [
                    TableCell(
                      child: Center(
                        child: Text('Paracetamol',textAlign: TextAlign.center,),
                      ),
                    ),
                    TableCell(
                      child: Center(
                ...
                TableRow(
                  children: [
                    TableCell(
                      child: Center(
                        child: Text('Naproxeno',textAlign: TextAlign.center,),
                      ),
                    ),
                    TableCell(
                      child: Center(
