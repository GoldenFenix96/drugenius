...
import 'package:drugenius/Paginas/nav_audios/class/audio_player_manager2.dart';
import 'package:flutter/material.dart';
import 'package:just_audio/just_audio.dart';



class AudioManager2 extends StatefulWidget {
  const AudioManager2({Key? key}) : super(key: key);

  @override
  State<AudioManager2> createState() => _AudioManager2();
}

class _AudioManager2 extends State<AudioManager2> {
